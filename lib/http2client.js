...
class Http2Fetch {
     ...
     */
    get(path, opts, cred) {
        return this.op(HTTP2_METHOD_GET, path, undefined, undefined, Object.assign({}, opts, { endStream: true }), cred);
    }
    /**
    ...
    delete(path, opts, cred) {
        return this.op(HTTP2_METHOD_DELETE, path, undefined, undefined, Object.assign({}, opts, { endStream: true }), cred);
    }
    /**
    ...
    post(path, body, contentType = 'application/json', opts, cred) {
        return this.op(HTTP2_METHOD_POST, path, body, contentType, Object.assign({}, opts, { endStream: false }), cred);
    }
    /**
    ...
    put(path, body, contentType = 'application/json', opts, cred) {
        return this.op(HTTP2_METHOD_PUT, path, body, contentType, Object.assign({}, opts, { endStream: false }), cred);
    }
}
